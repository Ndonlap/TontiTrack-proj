...
import OutlineButton from "../../../utils/components/Buttons/Button";
...
const Creationform = () => {
  ...
  // to add the tontine created in the tontine form
  const handleTontineList = async () => {
    // if(agree){

    console.log(dataForm);
    await fetch(`http://localhost:5000/api/tontine/getTontine`, {
      method: 'post',
      body: JSON.stringify({
        name: dataForm.name,
        description: dataForm.desc,
